...
function App() {
  ...
  const mintButtonClick = () =>{
    ...
    async function mintby()
    {
      ...
      contract.mintToken(address, text, function(err, result){
        if(err){
          console.error(err);
        } else{
          console.log(result);
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <input value={text} onChange={handleChange} type="text" placeholder='metadata uri'></input>
        <SyncButton handleClick={setUriValue} title = {"getVA"}></SyncButton>
        <SyncButton handleClick={mintButtonClick} title = {"Mint-ETH"}></SyncButton>
      </header>
    </div>
  );
}
